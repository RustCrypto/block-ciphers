...
global_asm!{
    ...
    //      - x3     must be valid pointers to memory regions of at least 240 bytes
    //      - on exit: x1 and x3 remain unchanged
    //      - on exit: x0 is overwritten with cipher-data
    ".balign 8",
    ".arch armv8-a+sve-aes+sve2",
    ".global aes_armv9_encdec_aes256_encrypt",
    ".type aes_armv9_encdec_aes256_encrypt, %function",
    "aes_armv9_encdec_aes256_encrypt:",
    ...
    "1:",
        ...
        "aesmc z31.b, z31.b",
        "aese  z31.b, z31.b, z12.b",            // perform AES-128 round 12 encryption
        "aesmc z31.b, z31.b",
...
global_asm! {
    ...
    ".balign 8",
    ".arch armv8-a+sve-aes+sve2",
    ".global aes_armv9_encdec_aes256_decrypt",
    ".type aes_armv9_encdec_aes256_decrypt, %function",
    "aes_armv9_encdec_aes256_decrypt:",
        "mov x8, #0",                           // loop counter {x8} := 0
    ...
    "1:",
        ...
        "aesimc z31.b, z31.b",
        "aesd   z31.b, z31.b, z12.b",           // perform AES-128 round 12 decryption
        "aesimc z31.b, z31.b",
        "aesd   z31.b, z31.b, z13.b",           // perform AES-128 round 13 decryption
        "eor    z31.b, z31.b, z14.b",           // perform AES-128 round 14 decryption
...
#[inline(always)]
pub fn encrypt_vla(keys: &RoundKeys<15>, mut data: InOut<'_, '_, Block>, blocks: usize) {
...
#[inline(always)]
pub fn decrypt_vla(keys: &RoundKeys<15>, mut data: InOut<'_, '_, Block>, blocks: usize) {
    let dst = data.get_out().as_mut_ptr();
    let src = data.get_in().as_ptr();
    let len = blocks * 16;
    let key = keys.as_ptr().cast::<u8>();
