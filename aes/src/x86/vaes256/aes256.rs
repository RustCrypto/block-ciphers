...
pub(crate) unsafe fn parallelize_keys(keys: &RoundKeys<15>) -> Simd256RoundKeys<15> {
    let mut v256: [MaybeUninit<__m256i>; 15] = MaybeUninit::uninit().assume_init();
    asm! {
        ...
        "vbroadcastf128 ymm13, [{keys} + 13 * 16]",
        "vbroadcastf128 ymm14, [{keys} + 14 * 16]",
        ...
        "vmovdqu [{optr} + 13 * 32], ymm13",
        "vmovdqu [{optr} + 14 * 32], ymm14",
...
pub(crate) unsafe fn encrypt32(
    ...
    crate::x86::ni::aes256::encrypt1(keys, blocks);
...
pub(crate) unsafe fn decrypt32(
    ...
    let blocks = InOut::from_raw(iptr.add(30), optr.add(30));
    crate::x86::ni::aes256::decrypt1(keys, blocks);
