...
#[inline]
pub(crate) unsafe fn parallelize_keys(keys: &RoundKeys<15>) -> Simd256RoundKeys<15> {
    [
...
pub(crate) unsafe fn encrypt30(
    simd_256_keys: &Simd256RoundKeys<15>,
    ...
    asm! {
        ...
        "vaesenc ymm14, ymm14, ymm0",
        "vaesenc ymm15, ymm15, ymm0",
        // aes-192 round 13 encrypt
        "vmovdqu ymm0 , [{simd_256_keys} + 13 * 32]",
        "vaesenc ymm1 , ymm1 , ymm0",
        "vaesenc ymm2 , ymm2 , ymm0",
        "vaesenc ymm3 , ymm3 , ymm0",
        "vaesenc ymm4 , ymm4 , ymm0",
        ...
        "vaesenc ymm14, ymm14, ymm0",
        "vaesenc ymm15, ymm15, ymm0",
        // aes-192 round 14 encrypt
        "vmovdqu ymm0, [{simd_256_keys} + 14 * 32]",
