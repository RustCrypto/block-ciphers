...
#[inline]
pub(crate) unsafe fn broadcast_keys(keys: &Simd128RoundKeys<13>) -> Simd512RoundKeys<13> {
    let mut v512: [MaybeUninit<__m512i>; 13] = MaybeUninit::uninit().assume_init();
    asm! {
...
#[inline]
pub(crate) unsafe fn encrypt64(keys: &Simd512RoundKeys<13>, blocks: InOut<'_, '_, Block64>) {
    ...
    asm! {
        ...
        "vaesenclast zmm16, zmm16, zmm12",
        "vaesenclast zmm17, zmm17, zmm12",
        "vaesenclast zmm18, zmm18, zmm12",
        "vaesenclast zmm19, zmm19, zmm12",
        "vaesenclast zmm20, zmm20, zmm12",
        "vaesenclast zmm21, zmm21, zmm12",
        "vaesenclast zmm22, zmm22, zmm12",
        "vaesenclast zmm23, zmm23, zmm12",
        "vaesenclast zmm24, zmm24, zmm12",
        "vaesenclast zmm25, zmm25, zmm12",
        "vaesenclast zmm26, zmm26, zmm12",
        "vaesenclast zmm27, zmm27, zmm12",
        "vaesenclast zmm28, zmm28, zmm12",
        "vaesenclast zmm29, zmm29, zmm12",
        "vaesenclast zmm30, zmm30, zmm12",
        "vaesenclast zmm31, zmm31, zmm12",
        // save cipher-data
...
#[inline]
pub(crate) unsafe fn decrypt64(keys: &Simd512RoundKeys<13>, blocks: InOut<'_, '_, Block64>) {
    let (iptr, optr) = blocks.into_raw();
    asm! {
        // load keys
        "vmovdqu32 zmm12, [{keys} +  0 * 64]",
        "vmovdqu32 zmm11, [{keys} +  1 * 64]",
        "vmovdqu32 zmm10, [{keys} +  2 * 64]",
        "vmovdqu32 zmm9 , [{keys} +  3 * 64]",
        "vmovdqu32 zmm8 , [{keys} +  4 * 64]",
        "vmovdqu32 zmm7 , [{keys} +  5 * 64]",
        "vmovdqu32 zmm6 , [{keys} +  6 * 64]",
        "vmovdqu32 zmm5 , [{keys} +  7 * 64]",
        "vmovdqu32 zmm4 , [{keys} +  8 * 64]",
        "vmovdqu32 zmm3 , [{keys} +  9 * 64]",
        "vmovdqu32 zmm2 , [{keys} + 10 * 64]",
        "vmovdqu32 zmm1 , [{keys} + 11 * 64]",
        "vmovdqu32 zmm0 , [{keys} + 12 * 64]",
        // load cipher-data
        "vmovdqu32 zmm16, [{iptr} +  0 * 64]",
        "vmovdqu32 zmm17, [{iptr} +  1 * 64]",
        "vmovdqu32 zmm18, [{iptr} +  2 * 64]",
        ...
        "vpxord zmm16, zmm16, zmm12",
        "vpxord zmm17, zmm17, zmm12",
        "vpxord zmm18, zmm18, zmm12",
        "vpxord zmm19, zmm19, zmm12",
        "vpxord zmm20, zmm20, zmm12",
        "vpxord zmm21, zmm21, zmm12",
        "vpxord zmm22, zmm22, zmm12",
        "vpxord zmm23, zmm23, zmm12",
        "vpxord zmm24, zmm24, zmm12",
        "vpxord zmm25, zmm25, zmm12",
        "vpxord zmm26, zmm26, zmm12",
        "vpxord zmm27, zmm27, zmm12",
        "vpxord zmm28, zmm28, zmm12",
        "vpxord zmm29, zmm29, zmm12",
        "vpxord zmm30, zmm30, zmm12",
        "vpxord zmm31, zmm31, zmm12",
