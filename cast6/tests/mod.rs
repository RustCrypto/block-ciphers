...
fn rfc2144_a() {
    ...
    let ct128 = GenericArray::from(hex!("c842a08972b43d20836c91d1b7530f6b"));
    let ct192 = GenericArray::from(hex!("1b386c0210dcadcbdd0e41aa08a7a7e8"));
    let ct256 = GenericArray::from(hex!("4f6a2038286897b9c9870136553317fa"));
    let pt = GenericArray::default();
