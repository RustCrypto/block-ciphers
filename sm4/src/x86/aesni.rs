...
#[inline]
pub fn sm4_encrypt4<T: BlockSizeUser>(blocks: InOut<'_, '_, ParBlocks4<T>>, rk: &[u32; 32]) {
    unsafe { sm4_process4::<T>(blocks, rk, true) }
}

#[inline]
pub fn sm4_decrypt4<T: BlockSizeUser>(blocks: InOut<'_, '_, ParBlocks4<T>>, rk: &[u32; 32]) {
