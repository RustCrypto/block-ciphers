...
pub(super) unsafe fn sm4_process8<T: BlockSizeUser>(
    block: InOut<'_, '_, ParBlocks8<T>>,
    rk: &[u32; 32],
    encrypt: bool,
) {
...
#[inline]
pub fn sm4_encrypt8<T: BlockSizeUser>(blocks: InOut<'_, '_, ParBlocks8<T>>, rk: &[u32; 32]) {
    unsafe { sm4_process8::<T>(blocks, rk, true) }
}

#[inline]
pub fn sm4_decrypt8<T: ParBlocksSizeUser>(blocks: InOut<'_, '_, ParBlocks8<T>>, rk: &[u32; 32]) {
